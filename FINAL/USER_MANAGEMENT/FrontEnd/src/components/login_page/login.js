...
function LoginPage() {
    ...
    function loginSubmit(e) {
        ...
        if (rememberMe.current.checked) {
            setCookie('User_Name', user_name.current.value, { path: '/', maxAge: 1 * 24 * 60 * 60 });
        ...
        fetch(hostURL + '/login', {
            ...
            .then((data) => {
                ...
                navigate(`/search/${user_name.current.value}`);
                return;
            }).catch((err) => {
                console.log(err);
            });
            ...
            <div className="container  p-5 login-page-content col-md-5">
                ...
                <form className="login-page-form">
                    <div className="form-group">
                        <label for="login-user-id" style={{ float: "left" }}><b>User ID or Email</b></label>
                    ...
                    <div className="form-group">
                        ...
                        <div className="password-field">
                            <input ref={password} onInput={checkInputFields} id="login-password" type={visible ? "text" : "password"} className="form-control" placeholder="Enter your password" />
